...
export const FETCH_OTHER_MATCHDAYS = 'leagues/FETCH_OTHER_MATCHDAYS'
export const SET_OTHER_MATCHDAYS = 'leagues/SET_OTHER_MATCHDAYS'
...
export const fetchOtherMatchdays = createAction(FETCH_OTHER_MATCHDAYS)
export const setOtherMatchdays = createAction(SET_OTHER_MATCHDAYS)